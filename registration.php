				...
				<div class="sign-up">
					...
					<div class="sign-u">
						...
						<div class="sign-up2">
								 ...
								 <input type="text" class="text"  name = "email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}">
					...
					<div class="sign-u">
						...
						<div class="sign-up2">
								 ...
								 <input type="password" class="Password" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
